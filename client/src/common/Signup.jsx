          ...
          <div className="relative bg-white/5 backdrop-blur-xl rounded-[32px] shadow-2xl border border-white/10 p-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-[#a8b3cf] text-base leading-relaxed">
                Join MyParking and find your perfect parking spot
              </p>
            </div>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full pl-12 pr-4 py-3.5 bg-white/5 border border-white/10 rounded-xl text-white focus:outline-none focus:border-[#4169E1] focus:ring-2 focus:ring-[#4169E1]/20 transition-all duration-300 text-sm appearance-none cursor-pointer"
                    required
                    disabled={loading}
                  >
              ...
              <div className="space-y-2">
                <label className="block text-[#a8b3cf] font-semibold text-sm">
                  Mobile Number <span className="text-[#6B7A99]">(Optional)</span>
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#6B8EFF]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
