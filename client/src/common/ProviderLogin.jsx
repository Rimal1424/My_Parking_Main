            ...
            <div className="relative flex items-center justify-center min-h-screen bg-gradient-to-br from-[#1a1f3a] via-[#2d3561] to-[#1a1f3a] overflow-hidden pt-20">
                ...
                <div className="relative z-10 w-full max-w-[480px] mx-4">
                    ...
                    <div className="text-center mb-10">
                        ...
                        <p className="text-[#6B8EFF] text-sm mt-2 font-semibold">Provider Portal</p>
                    </div>
                    ...
                    <div className="relative bg-white/5 backdrop-blur-xl rounded-[32px] shadow-2xl border border-white/10 p-10">
                        ...
                        <div className="text-center mb-8">
                            <h2 className="text-3xl font-bold text-white mb-3">Provider Login</h2>
                        ...
                        <div className="relative my-8">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-4 bg-[#2d3561]/80 text-[#6B7A99] rounded-full text-xs font-semibold">OR</span>
                            </div>
                        </div>
                        ...
                        <div className="bg-blue-500/10 border border-blue-400/30 rounded-2xl p-4 mb-6">
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                    <p className="text-blue-300 font-semibold text-sm mb-1">Provider Benefits</p>
                                    <p className="text-blue-200 text-xs">Manage your parking spaces, track bookings, and maximize revenue from your dashboard</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="text-center pt-6 border-t border-white/10">
                            <p className="text-sm text-[#a8b3cf]">
                                ...
                                <Link to="/provider-signup" className="text-[#6B8EFF] hover:text-[#8FA4FF] font-semibold transition-colors">
                        ...
                        <div className="text-center mt-4">
                            <p className="text-xs text-[#6B7A99]">
                                ...
                                <Link to="/login" className="text-[#6B8EFF] hover:text-[#8FA4FF] font-semibold transition-colors">
                                    Click here
                                </Link>
                            </p>
                        </div>
