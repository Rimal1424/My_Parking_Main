      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-emerald-600 to-teal-600 px-8 py-8">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-emerald-100 text-sm">Update your password to keep your account secure</p>
            </div>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 pr-12 border-2 border-gray-200 rounded-xl focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100 transition-all outline-none text-gray-900 placeholder-gray-400"
                  />
                  <button
                    type="button"
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-2">
                <button
                  onClick={handleSave}
                  disabled={loading}
                  className="flex-1 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white py-4 rounded-xl shadow-lg hover:shadow-xl hover:from-emerald-700 hover:to-emerald-800 transition-all duration-300 flex items-center justify-center gap-2 font-bold text-lg disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {loading ? (
                    <>
              ...
              <div className="text-center pt-2 border-t border-gray-200">
                <button
                  ...
                  className="text-indigo-600 hover:text-indigo-700 text-sm font-semibold transition-colors flex items-center justify-center gap-2 mx-auto group"
                >
        ...
        <div className="mt-6 bg-white rounded-xl shadow-lg border border-gray-100 p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-semibold text-gray-900 mb-1">Password Security Tips</p>
